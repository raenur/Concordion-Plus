...
public class SimpleMethodInvoker implements MethodInvoker {
    public void invokeAnnotatedMethods(ScenarioContext scenarioContext,
                                       Class<? extends Annotation> annotationClass) {
        Object fixtureObject = scenarioContext.getRootObject();
        ResultRecorder resultRecorder = scenarioContext.getResultRecorder();
        invokeAnnotatedMethods(fixtureObject, annotationClass, resultRecorder);
    }

    public void invokeAnnotatedMethods(Object fixtureObject,
                                       Class<? extends Annotation> annotationClass,
